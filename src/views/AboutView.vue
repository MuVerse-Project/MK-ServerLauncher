...
<template>
  <Card>
    <CardContent>
      <div class="flex flex-row not-md:flex-col items-center justify-center gap-5">
        <div>
        ...
        <div>
          ...
          <div class="-mt-0.5 text-xl">Ver.LunaLight V0.1.2</div>
          <div class="text-sm text-muted-foreground">By Mu_Mu</div>
        </div>
      </div>
      <separator class="my-4 border-2 border-black"/>
      <div>
